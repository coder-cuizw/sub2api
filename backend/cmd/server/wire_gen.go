...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	accountRepository := repository.NewAccountRepository(client, db, schedulerCache, secretEncryptor, configConfig)
	...
	accountCooldownCache := repository.ProvideAccountCooldownCache(redisClient)
	rateLimitService := service.ProvideRateLimitService(accountRepository, usageLogRepository, configConfig, geminiQuotaService, tempUnschedCache, timeoutCounterCache, openAI403CounterCache, accountCooldownCache, settingService, compositeTokenCacheInvalidator)
